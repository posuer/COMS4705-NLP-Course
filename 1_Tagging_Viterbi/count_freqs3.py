...
# updated to python3 by Alyssa Hwang, Feb 16, 2019
...
class Hmm(object):
    ...
    def train(self, corpus_file):
        ...
        for ngram in ngram_iterator:
            ...
            assert len(ngram) == self.n, "ngram in stream is {}, expected {}".format(len(ngram, self.n))
    ...
    def write_counts(self, output, printngrams=[1,2,3]):
        ...
        for word, ne_tag in self.emission_counts:            
            output.write("{} WORDTAG {} {}\n".format(self.emission_counts[(word, ne_tag)], ne_tag, word))
        ...
        for n in printngrams:            
            for ngram in self.ngram_counts[n-1]:
                ngramstr = " ".join(ngram)
                output.write("{} {}-GRAM {}\n".format(self.ngram_counts[n-1][ngram], n, ngramstr))
...
def usage():
    print("""python count_freqs.py [input_file] > [output_file]
